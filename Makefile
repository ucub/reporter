...
SRC:=$(GOPATH)/src/github.com/ucub/reporter
...
.PHONY: build
build: 
	go install -v github.com/ucub/reporter/cmd/grafana-reporter

.PHONY: buildlinux 
buildlinux: 	
	cmd //v //c "set GOOS=linux&&go install -v github.com/ucub/reporter/cmd/grafana-reporter"
...
.PHONY: docker-build
docker-build:
	@docker build -t yusufsanjaya24/grafana-reporter:2.3.0 -t yusufsanjaya24/grafana-reporter:latest .

docker-push:
	@docker push yusufsanjaya24/grafana-reporter
